...
export default function BoliviaMarketMobile() {
  ...
  return (
    <>
      <div className={styles.contentButtons}>
        <button className={styles.github}onClick={() => window.open('https://github.com/PaulSantiagoValdivia/bolivia-market', '_blank')}>
          <Github className={styles} />
        </button>
        <button className={styles.page}onClick={() => window.open('https://boliviamarket.vercel.app/', '_blank')}>
          <Explorer />
        </button>

...
export default function ZoonDesktop() {
  ...
  return (
    <>
      <div className={styles.contentButtons}>
        <button className={styles.githubDesktop} onClick={()=>window.open('https://github.com/PaulSantiagoValdivia/zoon', '_blank')}>
          <Github /> Ir al repositorio en Github
        </button>
        <button className={styles.pageDesktop} onClick={()=>window.open('https://zoonlabs.com', '_blank')}>
